...
public class Game {
    ...
    private static void fight() {
        ...
        while (true) {
            ...
            Ui.println("                            Battle!                               ");
            Ui.println("                                                                  ");
            Ui.println("                      Fighting: " + Enemy.get().getHeathStr());
            Ui.println("				     Enemy Health" + Enemy.get().getHeathStr());
            Ui.println("                     Your Health" + Health.getStr());
            Ui.println("------------------------------------------------------------------");
            Ui.println("1) Fight");
            Ui.println("2) Use First-Aid kit");
            Ui.println("3) Use a potion");
            Ui.println("4) Eat Food");
            Ui.println("5) Use Insta-Health");
            Ui.println("6) Use POWER");
            Ui.println("7) Find something else to fight(You will lose any XP earned)");
            Ui.println("8) Retreat");
            ...
            switch (menuChoice) {
                ...
                case 7:
                    Ui.cls();
                    Ui.popup("You ran away from this battle.", "Ran Away", JOptionPane.INFORMATION_MESSAGE);
                    Enemy.encounterNew();
                    break;
                case 8:
                    return;
